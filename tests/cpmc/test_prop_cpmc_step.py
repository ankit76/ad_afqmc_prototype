...
from ad_afqmc_prototype.prop.cpmc import cpmc_step
from ad_afqmc_prototype.prop.cpmc_slow import cpmc_step as cpmc_step_slow
from ad_afqmc_prototype.prop.hubbard_cpmc_ops import (
    _build_prop_ctx, 
...
def test_unrestricted_step_matches_cpmc_slow():
    ...
    cpmc_ops = make_hubbard_cpmc_ops(ham, sys.walker_kind)
...
def test_generalized_step_matches_cpmc_slow():
    key = jax.random.PRNGKey(42)
    norb, nup, ndn, nw = 5, 2, 1, 6
    params = QmcParams(dt=0.1, n_chunks=1)
...
if __name__ == "__main__":
    ...
    #test_unrestricted_step_matches_cpmc_slow()
    #test_unrestricted_step_is_chunk_invariant()
    #test_generalized_step_matches_cpmc_slow()
    #test_generalized_step_is_chunk_invariant()
